...
// клиенту и без плашки: здесь нужно только, ноль он или нет.
 ...
 *
 * 2. Архивируем только при НУЛЕВОМ балансе — счёт закрыт в обе стороны.
 *    Минус: человек должен студии. У архивного сняты все галочки, оплату
 *    принять нельзя, и архив спрячет долг.
 *    Плюс: студия должна человеку. Четыре неизрасходованных занятия — это
 *    не «не вернулся», это «вернётся, у него оплачено»; убрать такого
 *    значит спрятать чужие деньги.
 *    Первую половину правила подсказал автоархив уволенного педагога,
 *    вторую — живой случай: пробный с пятью оплаченными и одним посещённым
 *    занятием ушёл в архив на третий день.
 *
