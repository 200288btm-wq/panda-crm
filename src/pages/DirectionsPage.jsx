    ...
    if (removed.length) {
      ...
      if (toArchive.length) {
        toast.info(
          ...
          'В расписании их больше не будет, но отметки, часы и выплаты сохранены. Вернуть можно в этом же окне, внизу. Если ставки педагогов были заданы по этим подгруппам — проверьте раздел «Педагоги»: ставка направления ставки подгрупп не наследует.'
        )
      }
    }
