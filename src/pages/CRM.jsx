    ...
    <div className="app">
      ...
      <main className="main">
        ...
        <div className="content">
          ...
          {page === 'studio_settings' && isDirector && <StudioSettingsPage studio={studio} studioId={studio?.id} directions={directions} staffList={staffList} reload={load} clientStatuses={clientStatuses} clients={clients} payments={payments} expenses={expenses} teachers={teachers} subscriptions={subscriptions} />}}
